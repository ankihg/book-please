...
urlpatterns = [
    ...
    path('auth/bookWishes/books/<book_id>', views.cancel_book_wish, name='cancel book wish'),
    path('auth/bookWishes/books/<book_id>/grant', views.mark_book_wish_as_granted, name='mark book wish as granted'),
]
